...
/// Сравнить по имени l>r
START_TEST(test_film_cmp_name_l_more_r)
{
    struct film_t l;
    l.title = "Abba";
    l.name = "Aob";
...
/// Сравнить по имени l==r
START_TEST(test_film_cmp_name_l_eq_r)
{
    struct film_t l;
    l.title = "Abba";
    l.name = "Bob";
...
/// Сравнить по имени l<r
START_TEST(test_film_cmp_name_l_less_r)
{
    struct film_t l;
    l.title = "BaaB";
    l.name = "Bob";
...
Suite* film_cmp_name_suite(void)
{
    ...
    core = tcase_create("tests");
    tcase_add_test(core, test_film_cmp_name_l_more_r);
    tcase_add_test(core, test_film_cmp_name_l_eq_r);
    tcase_add_test(core, test_film_cmp_name_l_less_r);
...
/// Сравнить по году l>r
START_TEST(test_film_cmp_year_l_more_r)
{
    struct film_t l;
    l.title = "Abba";
    l.name = "Aob";
...
/// Сравнить по году l==r
START_TEST(test_film_cmp_year_l_eq_r)
{
    struct film_t l;
    l.title = "Abba";
    l.name = "Bob";
...
/// Сравнить по году l<r
START_TEST(test_film_cmp_year_l_less_r)
{
    struct film_t l;
    l.title = "BaaB";
    l.name = "Bob";
...
Suite* film_cmp_year_suite(void)
{
    ...
    core = tcase_create("tests");
    tcase_add_test(core, test_film_cmp_year_l_more_r);
    tcase_add_test(core, test_film_cmp_year_l_eq_r);
    tcase_add_test(core, test_film_cmp_year_l_less_r);
