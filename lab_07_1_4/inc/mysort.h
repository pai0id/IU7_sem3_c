...
/**
 * \brief Функция меняет местами два элемента размера n.
 * 
 * \param l [in, out] - указатель на левый элемент
 * \param r [in, out] - указатель на правый элемент
 * \param n [in] - размер элемнта
 */
